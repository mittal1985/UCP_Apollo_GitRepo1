...
public class CopyOfEmailUtility {
...
public void setEmail() {
	...
	br = new BufferedReader(new FileReader(".\\resultName.txt"));
	...
	System.out.println("foldername its going to click is -----"+folderName);
	...
	for (WebElement webElement2 : webElement) {
		...
		if(webElement2.getText().contains(folderName)){
			webElement2.click();
			break;
		}
	}	
