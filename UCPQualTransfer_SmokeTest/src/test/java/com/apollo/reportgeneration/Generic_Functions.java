package com.apollo.reportgeneration;
	 ...
	 // System.out.println("after test_step_unique_id"+test_step_unique_id);
	   ...
	   public static void WriteFailSalesforceQuery(WebDriver driver, HtmlReport currentsuit, String folder, String testCaseDescription, String expectedResult, String actualResult)
			     throws Exception
			    
	   {
		   long test_step_unique_id=0;
		   // test_step_unique_id = currentsuit.takeScreenshot(driver, folder);
		   currentsuit.writeReportFai_SalesforceIWD(testCaseDescription, expectedResult, actualResult, test_step_unique_id, folder);
	   }
	 
	   public static void WritePassSalesforceQuery(WebDriver driver, HtmlReport currentsuit, String folder, String testCaseDescription, String expectedResult, String actualResult)
			     throws Exception
			    
	   {
		   long test_step_unique_id=0;
   			// test_step_unique_id = currentsuit.takeScreenshot(driver, folder);
	     currentsuit.writeReportPassSalesforce_IWDQuery(testCaseDescription, expectedResult, actualResult, test_step_unique_id, folder);
	   }
	 
	 
	   public static void WritePassIWDQuery(WebDriver driver, HtmlReport currentsuit, String folder, String testCaseDescription, String expectedResult, String actualResult)
			     throws Exception
	   ...
	   public static void WriteFailIWDQuery(WebDriver driver, HtmlReport currentsuit, String folder, String testCaseDescription, String expectedResult, String actualResult)
			     throws Exception
