...
public class GoogleHangout_FF_static {
	...
	public static void setUp(String phonenumber){
	...
	public static void loginGmail(String phoneNumber){
		try{
		Thread.sleep(1000);
	...
	public static void loginHangouts(String phoneNumber){
		try{
			//driverGoogleHangout.get("https://hangouts.google.com/");
